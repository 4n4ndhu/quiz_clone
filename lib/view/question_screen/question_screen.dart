...
import 'package:quiz_clone/utils/animations_constants.dart';
import 'package:quiz_clone/utils/color_constants.dart';
import 'package:quiz_clone/view/category_screen/category_screen.dart';
import 'package:quiz_clone/view/result_screen/result_screen.dart';
...
class _QuestionScreenState extends State<QuestionScreen> {
  ...
  int currentIndex = 0;
  Timer? timer;
  int timerCount = 30; // Countdown time in seconds
  int totalTime = 30; // Total time for the question
